  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-dark-blue/95 backdrop-blur-sm shadow-lg' 
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between py-6">
          ...
          >
            ...
            <span className="text-2xl font-outfit font-bold text-soft-beige">
              noqi
            </span>
          </Link>
          ...
          <nav className="hidden md:flex space-x-8">
            <Link
              ...
              className={`font-inter font-medium transition-all duration-300 relative ${
                isActive('/') 
                  ? 'text-light-beige' 
                  : 'text-soft-beige hover:text-light-beige'
              }`}
            >
              Home
              {isActive('/') && (
                <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-light-beige"></span>
              )}
            </Link>
            <Link
              to="/about"
          ...
          {/* Mobile menu button */}
          <button className="md:hidden text-soft-beige">
